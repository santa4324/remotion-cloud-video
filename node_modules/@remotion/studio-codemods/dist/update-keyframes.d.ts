...
export declare const updateSequenceKeyframes: ({ input, nodePath, updates, schema, formatFile, prettierConfigOverride, videoConfigValues, }: {
    input: string;
    nodePath: SequenceNodePath;
    updates: SequenceKeyframeUpdate[];
    schema?: InteractivitySchema | undefined;
...
export declare const updateEffectKeyframes: ({ input, sequenceNodePath, effectIndex, updates, schema, formatFile, prettierConfigOverride, videoConfigValues, }: {
    input: string;
    sequenceNodePath: SequenceNodePath;
    effectIndex: number;
    updates: EffectKeyframeUpdate[];
