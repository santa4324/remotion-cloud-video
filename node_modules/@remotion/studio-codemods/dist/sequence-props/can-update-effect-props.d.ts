import type { CallExpression, File, JSXAttribute, JSXOpeningElement } from '@babel/types';
...
export declare const findEffectsAttr: (attributes: (JSXAttribute | import("@babel/types").JSXSpreadAttribute)[]) => JSXAttribute | null;
